...
protected:
	...
	// The default movement speed in Free Camera Mode.
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Free Camera Mode", meta = (UIMin = 500.0, UIMax = 25000.0, ClampMin = 500.0, ClampMax = 25000.0))
	float MovementSpeed = 7500.0;
